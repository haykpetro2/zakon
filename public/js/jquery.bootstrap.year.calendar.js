...
(function ($) {
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton = '<div class="jqyc" >' +

                '<div class="jqyc-months mx-0">' +
                ...
                '</div>' +
            '<div class="jqyc-year-chooser row align-items-center" data-current-year="' + year + '">' +
            '<div class="' + colColXs2 + ' text-left">' +

            '</div>' +
            '<div class="' + colColXs2 + ' text-right">' +
            '   <button type="button" class="btn btn-light btn-sm jqyc-prev-year jqyc-change-year" data-year="' + (year - 1) + '"><i class="fas fa-chevron-left f-24"></i></button>' +
            '</div>' +
            '<div class="jqyc-year ' + colColXs2 + ' col-lg-1">' + year + '</div>' +
            '<div class="' + colColXs2 + ' text-left">' +
            '   <button type="button" class="btn btn-light btn-sm jqyc-next-year jqyc-change-year" data-year="' + (year) + '"><i class="fas fa-chevron-right f-24"></i></button>' +
        ...
        if (settings.showHeaders) {
            $html.find('.jqyc-jan').append('<h5 class="jqyc-header mb-5">' + settings.l10n.jan + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-feb').append('<h5 class="jqyc-header mb-5">' + settings.l10n.feb + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-mar').append('<h5 class="jqyc-header mb-5">' + settings.l10n.mar + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-apr').append('<h5 class="jqyc-header mb-5">' + settings.l10n.apr + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-may').append('<h5 class="jqyc-header mb-5">' + settings.l10n.may + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-jun').append('<h5 class="jqyc-header mb-5">' + settings.l10n.jun + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-jul').append('<h5 class="jqyc-header mb-5">' + settings.l10n.jul + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-aug').append('<h5 class="jqyc-header mb-5">' + settings.l10n.aug + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-sep').append('<h5 class="jqyc-header mb-5">' + settings.l10n.sep + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-oct').append('<h5 class="jqyc-header mb-5">' + settings.l10n.oct + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-nov').append('<h5 class="jqyc-header mb-5">' + settings.l10n.nov + '</h5>');
        }
        ...
        var monthHTMLString = results.monthHTMLString;
        if (settings.showHeaders) {
            $html.find('.jqyc-dec').append('<h5 class="jqyc-header mb-5">' + settings.l10n.dec + '</h5>');
        }
